...
<div class="relative py-5">
    <div class="relative w-full max-w-5xl mx-auto px-8 text-gray-800 dark:text-white">
        ...
        <div class="font-baloo mb-6">
            <div class="mb-10">
                <h2 class="font-semibold text-2xl">Branding</h2>
                <p class="font-light leading-4">Customize the appearance of your application.</p>
                <div class="mt-2 mb-5 mx-auto block h-0 w-full no-underline border-b border-gray-300 overflow-hidden"></div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
                    <div class="col-span-1 md:col-span-2">
                        <p class="block text-base font-medium text-gray-700 dark:text-white transition-all duration-300">Application Name</p>
                        <div id="wsql-branding-name">
                    ...
                    <div>
                        <p class="text-base font-medium text-gray-700 dark:text-white">Application Logo (Light-mode)</p>
                        <div id="wsql-branding-logo-light">
                            <div class="flex gap-3 items-center mt-2">
                                <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 80 80" class="fill-black dark:fill-white animate-spin-fast">
                                    <g transform="translate(0.000000,85.000000) scale(0.100000,-0.100000)" stroke="none">
                                        <path d="M385 823 c125 -14 222 -79 272 -181 24 -49 28 -69 28 -143 0 -82 -2 -91 -44 -172 -48 -96 -49 -123 -5 -151 37 -25 77 -13 108 33 104 149 83 369 -47 503 -73 75 -179 119 -281 117 -34 -1 -47 -4 -31 -6z"/>
                    ...
                    <div>
                        <p class="text-base font-medium text-gray-700 dark:text-white">Application Logo (Dark-mode)</p>
                        <div id="wsql-branding-logo-dark">
                            <div class="flex gap-3 items-center mt-2">
                                <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 80 80" class="fill-black dark:fill-white animate-spin-fast">
                                    <g transform="translate(0.000000,85.000000) scale(0.100000,-0.100000)" stroke="none">
                                        <path d="M385 823 c125 -14 222 -79 272 -181 24 -49 28 -69 28 -143 0 -82 -2 -91 -44 -172 -48 -96 -49 -123 -5 -151 37 -25 77 -13 108 33 104 149 83 369 -47 503 -73 75 -179 119 -281 117 -34 -1 -47 -4 -31 -6z"/>
            ...
            <div class="mb-10">
                <h2 class="font-semibold text-2xl">User registration</h2>
                <p class="font-light leading-4">Here you can customize the behaviour of the user registration features.</p>
                <div class="mt-2 mb-5 mx-auto block h-0 w-full no-underline border-b border-gray-300 overflow-hidden"></div>
