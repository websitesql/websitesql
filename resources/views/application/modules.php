...
<div class="relative py-5">
    <div class="relative w-full max-w-5xl mx-auto px-8 text-gray-800 dark:text-white">
        <!-- Title -->
        <div class="font-baloo pt-6 mb-10">
            <h1 class="font-extrabold text-4xl">Modules</h1>
            <p class="font-light leading-4">Here you can manage your modules. Modules are extensions that add functionality to the application. You can enable or disable them here.</p>
        </div>
