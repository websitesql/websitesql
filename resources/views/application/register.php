...
<div class="font-baloo text-gray-800 dark:text-white transition-all duration-300">
    ...
    <p class="text-base">Welcome to Website SQL, please enter your details below to create an account.</p>
    ...
    <div class="mt-5 flex flex-col gap-3">
        <a href="<?= $this->getRoute('admin.login'); ?>" class="text-base text-indigo-600 dark:text-white hover:text-indigo-700 dark:hover:text-neutral-300 transition-all duration-300">Already have an account? Sign in here.</a>
    </div>
</div>