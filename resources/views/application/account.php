...
<div class="relative py-5">
    <div class="relative w-full max-w-5xl mx-auto px-8 text-gray-800 dark:text-white">
        ...
        <!-- Account -->
        <div class="font-baloo mb-6" data-page="account">
            <!-- Account Information -->
            <div class="mb-10">
                <h2 class="font-semibold text-2xl">About you</h2>
                <p class="font-light leading-4">Update your name, email address and avatar</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-8 mt-4">
                    <div class="col-span-1 md:col-span-9">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                <p class="block text-base font-medium text-gray-700 dark:text-white transition-all duration-300">Firstname</p>
                                <div data-input="wsql-account-firstname">
                                    <div class="flex gap-3 items-center mt-2">
                                        ...
                                        <h2 class="text-md font-baloo text-neutral-800 dark:text-white leading-6">Loading data - please wait...</h2>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <p class="text-base font-medium text-gray-700 dark:text-white">Surname</p>
                                <div data-input="wsql-account-lastname">
                                    <div class="flex gap-3 items-center mt-2">
                                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 80 80" class="fill-black dark:fill-white animate-spin-fast">
                                            <g transform="translate(0.000000,85.000000) scale(0.100000,-0.100000)" stroke="none">
                                                <path d="M385 823 c125 -14 222 -79 272 -181 24 -49 28 -69 28 -143 0 -82 -2 -91 -44 -172 -48 -96 -49 -123 -5 -151 37 -25 77 -13 108 33 104 149 83 369 -47 503 -73 75 -179 119 -281 117 -34 -1 -47 -4 -31 -6z"/>
                            ...
                            <div class="col-span-1 md:col-span-2">
                                <p class="text-base font-medium text-gray-700 dark:text-white">Email</p>
                                <div data-input="wsql-account-email">
                                    <div class="flex gap-3 items-center mt-2">
                                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 80 80" class="fill-black dark:fill-white animate-spin-fast">
                                            <g transform="translate(0.000000,85.000000) scale(0.100000,-0.100000)" stroke="none">
                                                <path d="M385 823 c125 -14 222 -79 272 -181 24 -49 28 -69 28 -143 0 -82 -2 -91 -44 -172 -48 -96 -49 -123 -5 -151 37 -25 77 -13 108 33 104 149 83 369 -47 503 -73 75 -179 119 -281 117 -34 -1 -47 -4 -31 -6z"/>
                            ...
                            <div class="col-span-1 md:col-span-2">
                                <div data-button="wsql-account-save"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-1 md:col-span-3">
                        <div data-input="wsql-account-avatar" class="flex justify-center">
                            <div class="flex gap-3 items-center mt-2">
                                <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 80 80" class="fill-black dark:fill-white animate-spin-fast">
                                    <g transform="translate(0.000000,85.000000) scale(0.100000,-0.100000)" stroke="none">
                                        <path d="M385 823 c125 -14 222 -79 272 -181 24 -49 28 -69 28 -143 0 -82 -2 -91 -44 -172 -48 -96 -49 -123 -5 -151 37 -25 77 -13 108 33 104 149 83 369 -47 503 -73 75 -179 119 -281 117 -34 -1 -47 -4 -31 -6z"/>
            ...
            <!-- Password Reset -->
            <div class="mb-10">
                <h2 class="font-semibold text-2xl">Update password</h2>
                <p class="font-light leading-4">Update your password using your current password</p>
                <div class="mt-2 mb-5 mx-auto block h-0 w-full no-underline border-b border-gray-300 overflow-hidden"></div>
                <div class="grid grid-cols-1 md:grid-cols-12 gap-3 mt-4">
                    <div class="col-span-1 md:col-span-8" data-component="wsql-account-updatePassword">
                        <div class="flex gap-3 items-center mt-2">
                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 80 80" class="fill-black dark:fill-white animate-spin-fast">
                                <g transform="translate(0.000000,85.000000) scale(0.100000,-0.100000)" stroke="none">
                                    <path d="M385 823 c125 -14 222 -79 272 -181 24 -49 28 -69 28 -143 0 -82 -2 -91 -44 -172 -48 -96 -49 -123 -5 -151 37 -25 77 -13 108 33 104 149 83 369 -47 503 -73 75 -179 119 -281 117 -34 -1 -47 -4 -31 -6z"/>
