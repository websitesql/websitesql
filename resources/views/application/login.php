...
<div class="font-baloo text-gray-800 dark:text-white transition-all duration-300">
    ...
    <p class="text-base">Welcome back to Website SQL, please enter your email address and password to sign into your account.</p>
    ...
    <div class="mt-5 flex flex-col gap-3">
        ...
        <a href="<?= $this->getRoute('admin.register'); ?>" class="text-base text-indigo-600 dark:text-white hover:text-indigo-700 dark:hover:text-neutral-300 transition-all duration-300">Don't have an account? Register here.</a>
    </div>
</div>