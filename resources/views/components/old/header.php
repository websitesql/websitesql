<div class="header" style="height: 70px;">
	<div class="wrapper">
		<a class="logo" href="/<?= $this->e($this->getStrings()->getAdminFilePath()); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 492 92">
                <g id="a16f57fb-9955-44f0-b080-4aad988676c8" class="svgText" fill="#000000" transform="matrix(4.934210588231973,0,0,4.934210588231973,99.93281521856602,-7.820207889927069)">
		...
		<div class="menu">
            <?php if ($this->userCheck() === true) { ?>
                <ul>
                    <li><a id="dark-mode"><i class="fa-solid fa-fw fa-moon"></i><span>Dark Mode</span></a></li>
                    <li><a href="/<?= $this->e($this->getStrings()->getAdminFilePath()); ?>?page=account"><i class="fa-solid fa-fw fa-user-circle"></i><span>Account</span></a></li>
                    <li><a href="/<?= $this->e($this->getStrings()->getAdminFilePath()); ?>?page=logout"><i class="fa-solid fa-fw fa-arrow-right-from-bracket"></i><span>Logout</span></a></li>
                </ul>
            <?php } else { ?>
                <ul>
					<li><a id="dark-mode"><i class="fa-solid fa-fw fa-moon"></i><span>Dark Mode</span></a></li>
					<li><a href="/<?= $this->e($this->getStrings()->getAdminFilePath()); ?>?page=login"><i class="fa-solid fa-fw fa-arrow-right-to-bracket"></i><span>Login</span></a></li>
					<li><a href="/<?= $this->e($this->getStrings()->getAdminFilePath()); ?>?page=register"><i class="fa-solid fa-fw fa-edit"></i><span>Register</span></a></li>
				</ul>
            <?php } ?>
		</div>
	</div>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="aboutModalLabel">About Website SQL v<?= $this->e($this->getStrings()->getVersion()); ?></h5>
			</div>
			<div class="modal-body">
				<p>© Copyright Alan Tiller 2018-<?= date('Y'); ?></p>
				<p>This program is built to make managing website content easier and simplier. The minimal code design means web pages load faster than most CMS's yet still included a lot of the features you'd come to expect.</p>
				<table class="table table-sm">
					<tbody>
								<tr>
								<th scope="row" style="width: 175px;">Browser</th>
									<td><?= $this->e($_SERVER['HTTP_USER_AGENT']); ?></td>
								</tr>
								<tr>
									<th scope="row">User IP Address</th>
									<td><?= $this->e($user_ip['address']); ?></td>
								</tr>
								<tr>
									<th scope="row">User IP Version</th>
									<td><?= $this->e($user_ip['version']); ?></td>
								</tr>
								<tr>
									<th scope="row">User Location</th>
									<td><?= $this->e($user_location['city']); ?>, <?= $this->e($user_location['country_code']); ?></td>
								</tr>
								<tr>
									<th scope="row">User ISP</th>
									<td><?= $this->e($user_location['org']); ?></td>
								</tr>
								<tr>
									<th scope="row">Database Version</th>
									<td><?= $this->e($this->getSetting('DatabaseVersion')); ?></td>
								</tr>
								<tr>
									<th scope="row">Application Version</th>
									<td><?= $this->e($this->getStrings()->getVersion()); ?></td>
								</tr>
								<tr>
									<th scope="row">Application Release ID</th>
									<td><?= substr(str_repeat(0, 6) . $this->getStrings()->getReleaseID(), - 6); ?></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><?= $this->e($this->getSetting('WebsiteName')); ?></td>
								</tr>
								<tr>
									<th scope="row">Website Theme</th>
									<td><?= $this->e($this->getSetting('WebsiteTheme')); ?></td>
								</tr>
								<tr>
