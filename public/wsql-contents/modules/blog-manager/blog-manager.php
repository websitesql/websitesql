<?php /* Website SQL - Blog Manager Module - V0.0.1 - (C) Copyright Alan Tiller 2024. */
...
class BlogManager
{
     ...
     * @var string
     */
    private $moduleName = 'Blog Manager';
     ...
     * @var string
     */
    private $moduleDescription = 'Make blog management easy with the Blog Management module, detailed news and blogging services.';
    ...
    public function __construct($appInstance)
    {
        ...
        $this->modulePath = $this->app->getModulePath() . '/blog-manager';
    }
