<?php /* Website SQL - Event Manager Module - V0.0.1 - (C) Copyright Alan Tiller 2024. */
...
class EventManager
{
     ...
     * @var string
     */
    private $moduleName = 'Event Manager';
     ...
     * @var string
     */
    private $moduleDescription = 'Make event management easy with the Event Management module, easy bookings and information.';
    ...
    public function __construct($appInstance)
    {
        ...
        $this->modulePath = $this->app->getModulePath() . '/event-manager';
    }
