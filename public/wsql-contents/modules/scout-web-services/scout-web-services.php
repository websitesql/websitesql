<?php /* Website SQL - Scout Web Services Module - V0.0.1 - (C) Copyright Alan Tiller 2024. */

class ScoutWebServices
{
    /*
     ...
     * @var string
     */
    private $moduleName = 'Scout Web Services';
     ...
     * @var string
     */
    private $moduleDescription = 'This module provides the following services for the Scout Web Services platform: API Integration, OSM Features, Training, Groups and People.';
    ...
    public function __construct($appInstance)
    {
        ...
        $this->modulePath = $this->app->getModulePath() . '/scout-web-services';
    }
