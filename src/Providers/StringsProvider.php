...
class StringsProvider
{
    ...
    {
        return $_ENV['APP_ADMIN_PATH'] ?? "admin";
    }

    /*
     * This method returns the WebsiteSQL table content
     * 
     * @return string
     */
    public function getTableContent(): string
    {
        return "WebSQL_Content";
    }

    /*
     * This method returns the WebsiteSQL table content types
     * 
     * @return string
     */
    public function getTableContentTypes(): string
    {
        return "WebSQL_ContentTypes";
    }

    /*
     * This method returns the WebsiteSQL table settings
     * 
     * @return string
     */
    public function getTableSettings(): string
    {
        return "WebSQL_Settings";
    }

    /*
     * This method returns the WebsiteSQL table temp content
     * 
     * @return string
     */
    public function getTableTempContent(): string
    {
        return "WebSQL_TempContent";
    }
    ...
    {
        return "WebSQL_Tokens";
    }

    /*
     * This method returns the WebsiteSQL table uploads
     * 
     * @return string
     */
    public function getTableUploads(): string
    {
        return "WebSQL_Uploads";
    }
    ...
    /*
     * This method returns the WebsiteSQL table messages log
     * 
     * @return string
     */
    public function getTableMessagesLog(): string
    {
        return "WebSQL_MessagesLog";
    }

    /*
     * This method returns the WebsiteSQL table website log
     * 
     * @return string
     */
    public function getTableWebsiteLog(): string
    {
        return "WebSQL_WebsiteLog";
    }

    /*
     * This method returns the WebsiteSQL table admin log
     * 
     * @return string
     */
    public function getTableAdminLog(): string
    {
        return "WebSQL_AdminLog";
    }

    /*
     * This method returns the WebsiteSQL table transaction log
     * 
     * @return string
     */
    public function getTableTransactionLog(): string
    {
        return "WebSQL_TransactionLog";
    }
