...
namespace WebsiteSQL\WebsiteSQL\Controllers\Http\Api\Users\Register;
...
class PostController implements RequestHandlerInterface
{
    ...
    {
        $user = $this->app->getDatabase()->get($this->app->getStrings()->getTableUsers(), '*', ['id' => $id]);
        ...
        $this->app->getMail()->send($email, 'Verify your email address', 'emails/verify-email', [
            'uuid' => $uuid
        ]);
